...
A multi-camera system meant for cargo vechicle monitoring built with Python and PyQt6, optimized for Raspberry Pi but compatible with any Linux system. Features real-time video streaming, dynamic performance tuning, hot-plugging support, and an intuitive touch-enabled interface.
